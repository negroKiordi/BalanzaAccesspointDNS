...
<style>
  ...
  <body style="background-color: #efefef" onload="process()">
    ...
    <main class="container">
      <div class="category" id ="pesoestable">0000 kg</div>
      <div style="border-radius: 10px !important;">
    </div>
    <br>
    <div class="category" id = "caravana">ID 000000</div>
    <br>
  ...
  <footer div class="foot" id = "temp" >Balanza Wep App</div></footer>
  ...
  <script type = "text/javascript">
    ...
    function response(){
      ...
      xmldoc = xmlResponse.getElementsByTagName("peso"); 
